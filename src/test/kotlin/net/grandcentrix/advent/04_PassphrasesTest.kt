...
class PassPhrasesTest{
    ...
    private val testInput = listOf("sayndz zfxlkl attjtww cti sokkmty brx fhh suelqbp", 
    ...
    fun `"aa bb cc dd ee" is valid`() {
        Assertions.assertThat(isPassphraseValid("aa bb cc dd ee")).isEqualTo(true)
    }

    @Test
    fun `"aa bb cc dd aa" is not valid`() {
        Assertions.assertThat(isPassphraseValid("aa bb cc dd aa")).isEqualTo(false)
    }

    @Test
    fun `"aa bb cc dd aaa" is valid`() {
        Assertions.assertThat(isPassphraseValid("aa bb cc dd aaa")).isEqualTo(true)
    }

    @Test
    fun `test input has 383 valid rows`() {
